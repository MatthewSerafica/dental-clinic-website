...
class StudentController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            return Inertia::render('Dentist/Students/Index', compact('students', 'filters', 'schools'));
        } catch (Exception $e) {
    ...
    {
        try {
            $student = Student::with(['medicals', 'charts', 'examinations', 'user'])
                ->where('id', $id)->first();
            ...
            return inertia('Dentist/Students/Show', [
                'student' => $student,
    ...
    public function update(Request $request, $id_number)
    {
        try {
            ...
            $student->updated_by = "Dr. " . Auth::user()->name;
            $student->update();
    ...
    public function unarchive($id)
    {
        try {
            ...
            return redirect()->to('/archives')
                ->with('success', 'Student record was unarchived!');
        } catch (ModelNotFoundException $e) {
            DB::rollBack();
            return redirect()->back()->with('error', 'Record not found.');
        } catch (Exception $e) {
    ...
    public function printRecord($id)
    {
        try {
            ...
            return inertia('Dentist/Students/PrintRecord', [
                'student' => $student,
                'medical' => $student->medicals,
                'chart' => $student->charts,
                'exam' => $student->examinations,
    ...
    public function printCertificate($id)
    {
        try {
            $student = Student::where('id', $id)->first();
            return inertia('Dentist/Students/PrintCertificate', [
                'student' => $student,
            ]);
        } catch (ModelNotFoundException $e) {
            return redirect()->back()->with('error', 'Record not found.');
