    ...
    if (idNumber.value.length === 7) {
        try {
            if (idNumber.value.includes(' ')) {
                ...
                if(employees.value.middle_name === null){
                    full_name.value = employees.value.last_name + ", " + employees.value.first_name;
                }else{
                ...
                if (!students.value.middle_name === null) {
                    full_name.value = students.value.last_name + ", " + students.value.first_name + ", " + students.value.middle_name;
                } else {
                    full_name.value = students.value.last_name + ", " + students.value.first_name;
                }
...
const formatDate = (date) => {
  return date ? format(date, 'dd/MM/yyyy') : ''; // adjust the format string as needed
};
