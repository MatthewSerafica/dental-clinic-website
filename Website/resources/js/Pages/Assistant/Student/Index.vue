    ...
    <MainLayout>
        <template v-slot:mainContent>
            <div class="flex flex-col ml-2 max-sm:px-5">
                <h1 class="w-20 h-8 text-2xl font-bold text-gray-700 max-sm:ml-4">Students</h1>
                <h6 class="h-1 text-xs text-gray-400 max-sm:ml-4">
                    <a href="/assistant">Home</a> > Students
                </h6>
            </div>
                                ...
                                <tbody class="flex-1 sm:flex-none">
                                    <tr class="flex flex-col mb-2 flex-no wrap sm:table-row sm:mb-0 max-sm:border max-sm:roun hover:bg-gray-100"
                                        ...
                                        <td class="p-3 border-grey-light sm:border-b hover:bg-gray-100 max-sm:hidden">
                                            <Link :href="`/assistant/student/${student.id}`" class="flex flex-col">
                                        ...
                                        <Link :href="`/assistant/student/${student.id}`" class="flex flex-col sm:hidden">
...
import Create from "@/Pages/Assistant/Student/Create.vue"
