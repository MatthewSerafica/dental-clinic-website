...
const form = useForm({
  ...
  time_in: props.student.user.time_in,
...
const createRecord = () => form.post(
  route("student.treatment.store", props.student.id_number), { preserveScroll: false, preserveState: false }
)
</script>
        ...
        <div class="p-4">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-2">
            ...
            <div class="mb-4">
              ...
              <textarea id="remarks" v-model="form.remarks" type="text" class="w-[17rem] px-3 py-2 border rounded"
                required />
            </div>
          </div>
        </div>
