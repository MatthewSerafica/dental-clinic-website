<template>
    <div class="relative left-6 items-center">
                    ...
                    <tr v-for="treatment in treatments.data" :key="treatment.record_id"
                        ...
                        <th class="px-6 py-4">
                            <button @click="$emit('openEditTreatment', treatment)" type="button"
                                class="w-10 h-6 pl-3 text-white bg-blue-500 rounded-xl hover:bg-blue-700">
                                <editicon></editicon>
                            </button>
                        </th>
                    </tr>
        ...
        <div v-if="treatments.data.length" class="flex justify-center w-full mt-6 mb-6">
