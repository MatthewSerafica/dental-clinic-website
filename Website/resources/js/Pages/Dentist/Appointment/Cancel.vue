                ...
                <div class="items-center justify-center w-full h-full text-center">
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col">
                            <label for="reason" class="text-left">Reason<span class="text-red-700">*</span></label>
                            <input id="reason" v-model="cancel.reason" class="rounded-lg" type="text" required />
                            <div v-if="cancel.errors.reason" class="px-2 text-sm text-red-600">
...
function markAsCancelled(appointment) {
    cancel.put(route('appointment.update', appointment.app_id))
}
