    ...
    <MainLayout>
        <template v-slot:mainContent>
            <div class="flex flex-col ml-2 max-sm:px-5">
                <h1 class="w-20 h-8 text-2xl font-bold text-gray-700 max-sm:ml-4">Departments</h1>
                <h6 class="h-1 text-xs text-gray-400 max-sm:ml-4">
                    <a href="/admin">Home</a> > Departments 
                </h6>
            </div>
            ...
            <div class="relative flex flex-col flex-grow mt-8 bg-white max-sm:ml-10 rounded-xl">
                            ...
                            <table class="w-full my-5 overflow-hidden rounded-lg sm:bg-white sm:shadow-lg">
                                ...
                                <tbody class="flex-1 sm:flex-none">
                                    <tr class="flex flex-col mb-2 flex-no wrap sm:table-row sm:mb-0 max-sm:border max-sm:roun hover:bg-gray-100"
                                        v-for="(department, index) in departments.data" :key="department.id">
                                        <td
                ...
                <Edit v-if="isShowEdit" :department="selectedDepartment" @closeEdit="closeEdit" />
                <Delete v-if="isShowDelete" :department="selectedDepartment" @closeDelete="closeDelete" />
...
import Create from "@/Pages/Admin/Departments/Create.vue";
import Delete from "@/Pages/Admin/Departments/Delete.vue";
import Edit from "@/Pages/Admin/Departments/Edit.vue";
