<template>
    <Modal size="lg" @close="closeDelete">
        <template #header>
            ...
            <div class="items-center justify-center w-full h-full text-center">
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <p>the {{ department.departments }} department?</p>
                    </div>
                </div>
            </div>
        </template>
        <template #footer>
            <div class="relative w-full h-8">
                <div class="absolute right-0">
                    <button @click="closeDelete" type="button" as="button"
                    ...
                    <Link method="delete" :href="route('admin.departments.delete', { id: department.id })" type="button" as="button" @click="closeDelete"
