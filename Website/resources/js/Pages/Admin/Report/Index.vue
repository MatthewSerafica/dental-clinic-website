<template>
    <MainLayout class="">
        <template v-slot:mainContent>
            <div class="relative flex flex-col  origin-[left_top] inline-block scale-[0.86]">
                <div class="relative flex flex-col ml-2">
                    <h1 class="text-2xl font-bold text-gray-700">
                        Reports
                    </h1>
                    <h6 class="h-1 text-xs text-gray-400">
                        <a href="/admin">Home</a> > Reports
                    </h6>
                </div>

                <div class="relative top-[80px] drop-shadow-lg flex flex-col gap-10 items-center">
                    <div class="flex items-center gap-10 font-medium text-center desktop:left-[88rem] laptop:left-[66rem]">
                        <a :href="route('admin.reports.daily')" target="_blank"
                        ...
                        <a :href="route('admin.reports.monthly')" target="_blank"
                            class="w-40 px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:ring-green-400">
...
<script setup>
import DailyBar from '@/Pages/Admin/Report/Charts/DailyBar.vue'
import MonthlyBar from '@/Pages/Admin/Report/Charts/MonthlyBar.vue'
import OverallDaily from '@/Pages/Admin/Report/Charts/OverallDaily.vue'
import OverallMonthly from '@/Pages/Admin/Report/Charts/OverallMonthly.vue'
