            ...
            <div class="grid grid-cols-1 left-10 gap-y-4">
              <div class="mb-4">
                ...
                <select class="w-[12.9rem] px-3 py-2 border rounded" v-model="form.service_rendered" required>
                  ...
                  <option>Varsity/Intrams</option>
                  <option>Emergency Cases</option>
                  <option>Excuses Slip</option>
...
const updateRecord = () => form.put(
    route("admin.student.treatment.update", props.treatment.record_id), { preserveScroll: false, preserveState: false }
)
