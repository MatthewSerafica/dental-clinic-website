        ...
        <Modal size="4xl" class="md:flex md:space-y-0 md:space-x-4" @close="closeModal">
            ...
            <template #body>
                ...
                <div class="px-4">
                    ...
                    <!---start of row 1-->
                    <div class="w-64 max-sm:w-full pb-2">
                    ...
                    <div class="flex flex-row gap-4 pb-2 max-sm:flex-col">
                        <div class="">
                            ...
                            <select class="h-10 rounded-md drop-shadow-lg w-[8em] max-sm:w-full capitalize" v-model="form.sex"
                                required>
                        ...
                        <div class="">
                            ...
                            <select class="h-10 rounded-md drop-shadow-lg w-[11em] max-sm:w-full capitalize"
                        ...
                        <div class="">
                            ...
                            <input id="birth_date" v-model="form.birth_date" type="date"
                                class="h-10 rounded-md drop-shadow-lg w-[9em] max-sm:w-full" required>
                        </div>
                    ...
                    <div class="flex flex-row gap-6 pb-2 max-sm:flex-col">
                        <div class="">
                            ...
                            <input id="allergy" v-model="form.allergies" type="text"
                                class="h-10 rounded-md drop-shadow-lg w-[13rem] max-sm:w-full" placeholder="input 'none' if none">
                        </div>
                    ...
                    <div class="flex flex-row gap-6 pb-3 max-sm:flex-col">
                        <div class="w-52 max-sm:w-full">
                            ...
                            <input v-if="form.diabetes_option === 'YES'" id="Diabetes" v-model="form.diabetes" type="text"
                                class="h-10 rounded-md drop-shadow-lg w-[13rem] mt-1 max-sm:w-full" placeholder="if YES type here">
                        </div>
...
const form = useForm({
    ...
    allergies: props.employee.medicals.allergies,
    diabetes: props.employee.medicals.diabetes,
    blood_dyscrasia: props.employee.medicals.blood_dyscrasia,
    cns_disorder: props.employee.medicals.cns_disorder,
    cardiovascular_disease: props.employee.medicals.cardiovascular_disease,
    tooth_related_surgery: props.employee.medicals.tooth_related_surgery,
    other_conditions: props.employee.medicals.other_conditions,
})
...
watch(() => form.id_number, async (newValue) => {
    ...
    if (!form.errors.id_number) {
        try {
            const { data } = await axios.get(route('admin.employee.check', newValue));
            if (data.exists) {
...
const update = () => form.put(route('admin.employee.update', props.employee.id_number), { preserveScroll: false, preserveState: false })
</script>