                ...
                <div class="px-4">
                    ...
                    <div class="flex flex-row gap-4 pb-2 max-sm:flex-col">
                        <div class="">
                            ...
                            <select class="h-10 rounded-md drop-shadow-lg w-[8em] max-sm:w-full capitalize"
...
const update = async () => {
    ...
    form.put(route('admin.employee.update', props.employee.id_number), { preserveScroll: false, preserveState: false })
}
</script>