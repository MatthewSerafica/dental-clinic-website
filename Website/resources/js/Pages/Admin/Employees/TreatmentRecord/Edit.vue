...
const update = () => form.put(
    route("admin.employee.treatment.update",props.treatment.record_id),{ preserveScroll: false, preserveState: false })
</script>
        ...
        <Modal size="3xl" @close="closeModal">
            <template #header>
                <div class="flex items-center px-4 text-lg">
                    Edit Employee's Treatment Record
                </div>
            </template>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2">
              ...
              <div class="mb-4">
                ...
                <textareat id="remarks" v-model="form.remarks" type="text"
                    class="w-[17rem] px-3 py-2 border rounded" required />
              </div>
            </div>
          </div>
