    ...
    <MainLayout>
        <template v-slot:mainContent>
            <div class="flex flex-col">
                <div class="relative mb-5 ml-2 max-lg:mb-5">
                    <h1 class="w-20 h-8 text-xl font-bold text-gray-700">Welcome,&nbsp;Administrator
                    </h1>
                    <h2 class="text-lg text-gray-700">Have a nice day!</h2>
                </div>
            </div>

            <div class="flex flex-col flex-grow gap-4 rounded-xl">
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                    <div class="flex flex-col h-full gap-4 rounded-lg lg:col-span-2">
                        ...
                        <div
                            class="w-full h-[34rem] bg-white rounded-lg p-8 flex flex-col items-center mt-0 md:h-[34rem] drop-shadow-md">
                    ...
                    <div class="flex flex-col gap-4 max-lg:gap-20">
                        ...
                        <div class="w-full h-full bg-white rounded-lg drop-shadow-md">
                            <div class="flex flex-row justify-between">
                                ...
                                <div class="mt-4 mr-4">
                                    <Link :href="route('admin.appointment.index')" class="text-blue-500 font-base">View All</Link>
                                </div>
                            </div>
...
const page = usePage()
const fullName = page.props.user.name
