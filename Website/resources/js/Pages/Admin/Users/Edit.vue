                    ...
                    <div
                        ...
                        <form @submit.prevent="update">
                            <div
                                ...
                                <div class="row-start-4 px-[3em]">
                                    ...
                                    <div class="grid grid-cols-3 left-10 gap-y-5">
                                        ...
                                        <div>
                                            ...
                                            <input v-if="form.user_type === 'employee' || form.user_type === 'student'" class="rounded-md textbox laptop:w-80 drop-shadow-lg" v-model="form.name"
                                                type="text" placeholder="Juan dela Cruz" disabled>
                                            <input v-else class="rounded-md textbox laptop:w-80 drop-shadow-lg" v-model="form.name"
                                ...
                                <!--CTAs-->
                                <div class="relative left-[108px] grid grid-cols-10 row-start-12 gap-x-2 pb-14">
                                    ...
                                    <div class="relative left-7 laptop:col-start-10 desktop:col-start-9 left">
