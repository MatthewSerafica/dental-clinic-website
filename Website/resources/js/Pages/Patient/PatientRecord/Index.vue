<template>
    ...
    <div class="relative w-[700px] h-[350px] md:w-[1200px] md:h-[200px] left-7 top-[5rem] bg-[#ffffff]">
            <div class="flex flex-wrap md:justify gap-[4rem] relative top-5 left-7">
                <div>
                    <h1 class="text-gray-400 deets">ID Number</h1>
                    <h2 class="details"> {{ patients.id }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Last Name</h1>
                    <h2 class="details"> {{ patients.last_name }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">First Name</h1>
                    <h2 class="details"> {{ patients.first_name }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Gender</h1>
                    <h2 class="capitalize details"> {{ patients.sex }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Email</h1>
                    <h2 class="details"> test</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Age</h1>
                    <h2 class="details">test</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Birth Date </h1>
                    <h2 class="details"> {{ patients.birth_date }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Civil Status</h1>
                    <h2 class="details"> {{ patients.civil_status }}</h2>
                </div>
                <div></div>
                <div>
                    <h1 class="text-gray-400 deets">Address </h1>
    ...
    <div class="relative w-[700px] h-[350px] md:w-[1200px] md:h-[200px] left-[47rem] top-[-19.1rem] md:left-7 md:top-[8rem] bg-[#ffffff] rounded ">
            <div class="flex flex-wrap md:justify gap-[3rem] relative top-5 left-7">
                <div>
                    <h1 class="text-gray-400 deets">Allergy </h1>
                    <h2 class="details"> {{ patients.allergy }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Diabetes </h1>
                    <h2 class="details"> {{ patients.diabetes }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Blood Dyscrasia</h1>
                    <h2 class="details"> {{ patients.blood_dyscrasia }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Cardio vascular disease</h1>
                    <h2 class="details"> {{ patients.cardiovascular_disease }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Disorder</h1>
                    <h2 class="details"> {{ patients.cns_disorder }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets">Other</h1>
                    <h2 class="details"> {{ patients.other }}</h2>
                </div>
                <div>
                    <h1 class="text-gray-400 deets"> Dental Related disease</h1>
                    <h2 class="details"> {{ patients.other }}</h2>
                </div>
