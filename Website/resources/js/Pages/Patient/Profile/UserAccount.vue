    ...
    <MainLayout>
        <template v-slot:mainContent>
            <div class="flex flex-col ml-2">
                <h1 class="w-20 h-8 text-2xl font-bold text-gray-700">Account</h1>
                <h6 class="h-1 text-xs text-gray-400">
                    <a href="/patient">Home</a> > Account
                </h6>
            </div>
                        ...
                        <div class="flex flex-col pt-4 left-10">
                            ...
                            <div class="flex flex-row gap-5 pt-2 max-md:flex-col">
                                <div>
                                    ...
                                    <input @keydown.space.prevent class="rounded-md textbox laptop:w-80 drop-shadow-lg" v-model="form.password"
                                        type="password" />
...
const update = () => {
    if (form.password === form.confirmPassword) {
        form.put(route('patient.user.update', props.nuser.id));
    } else {
